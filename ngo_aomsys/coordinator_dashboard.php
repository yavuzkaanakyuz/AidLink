...
<body>
    ...
    <div class="content">
        ...
        <div class="buttons-container">
            <form action="view_all_requests.php" method="post">
                <input type="submit" value="View All Requests">
            </form>
            <form action="view_all_donations.php" method="post">
                <input type="submit" value="View All Donations">
            </form>
            <form action="organize_publicity_events.php" method="post">
                <input type="submit" value="Organize Publicity Events">
            </form>
            <form action="view_all_publicity_events.php" method="post">
                <input type="submit" value="View All Publicity Events">
            </form>
            <form action="show_volunteers.php" method="post">
